...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
    ...
    ekf_.Q_ = MatrixXd(4,4); // Create the covariance matrix
  ...
  */
  ...
  ekf_.Q_ <<  deltaT4/4*noise_ax, 0, deltaT3/2*noise_ax, 0,
		   0, deltaT4/4*noise_ay, 0, deltaT3/2*noise_ay,
		   deltaT3/2*noise_ax, 0, deltaT2*noise_ax, 0,
		   0, deltaT3/2*noise_ay, 0, deltaT2*noise_ay; 
